...
if __name__ == "__main__":
    ...
    print("\n>>> Step 4: Comparing Masks (Jaccard Similarity)")
    similarity = calculate_iou(mask_adam, mask_sgd)
    
    print("="*40)
    print(f"Jaccard Similarity (IoU): {similarity:.4f}")
    print(f"Overlap Percentage: {similarity * 100:.2f}%")
    print("="*40)
    
    if similarity < 0.5:
        print("CONCLUSION: The optimizers found SIGNIFICANTLY DIFFERENT winning tickets.")
    else:
        print("CONCLUSION: The optimizers found SIMILAR winning tickets.")